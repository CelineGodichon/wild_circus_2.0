...
class City
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Performance", mappedBy="city", orphanRemoval=true)
     */
    ...
    public function removePerformance(Performance $performance): self
    {
        if ($this->performances->contains($performance)) {
            ...
            if ($performance->getCity() === $this) {
                $performance->setCity(null);
            }
        }
